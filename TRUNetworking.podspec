...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yxfGithub/TRUNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yxfGithub' => 'yxf_myself@163.com' }
  s.source           = { :git => 'https://github.com/yxfGithub/TRUNetworking.git', :tag => s.version.to_s }
